...
while True:
    ...
    while not full_ready and connected:
        ...
        draw_text(f'You are player  {"2" if is_player2 else "error"}', medium_font, WHITE, SCREEN_WIDTH // 2, SCREEN_HEIGHT // 2 - 80)
    ...
    while not level_selected and full_ready:
        ...
        '''
        if is_player1:
            draw_text('You are Player 1. Select a level', big_font, WHITE, SCREEN_WIDTH // 2, SCREEN_HEIGHT // 3)'''
        if is_player2:
            draw_text('You are Player 2. Waiting for Player 1 to select level', small_font, WHITE, SCREEN_WIDTH // 2, SCREEN_HEIGHT // 3)
    ...
    while level_selected and not in_game:
        print("4")
        screen.fill(BLACK)
        ...
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                ...
                if event.key == pygame.K_0:
                    ...
                    game_over = False
                    print(in_game)
                    print('full_ready:', full_ready)
                    print('is_player1:', is_player1)
                    print('is_player2:', is_player2)
                    print('is_player1_ready:', is_player1_ready)
                    print('is_player2_ready:', is_player2_ready)
                    print('start1:', start1)
                    print('start2:', start2)
                    print('connected:', connected)
                    print('level_selected:', level_selected)
